                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-read-more">
                                                    <div class="row" style="padding: 0.5rem 0 0.5rem 0">
                                                        <div class="col-6">
                                                            <button id="searchWord_{{ $searchedWordResult[1][$i]['id'] }}" class="like likeFlag_{{ $searchedWordResult[1][$i]['id'] }} reset-button" value="{{ $searchedWordResult[1][$i]['likeFlag'] }}">
                ...
                @if ($searchedWordResult[0]['lastPage'] !== 1)
                    <div class="col-12">
                        <div class="more" style="padding-top:2rem">
                            <a href="{{ route('searchWord', ['searchWords' => $searchWords, 'nextPage' => $searchedWordResult[0]['nextPage']]) }}">もっと見る</a>
                        </div>
                    </div>
                @endif
            </div>
